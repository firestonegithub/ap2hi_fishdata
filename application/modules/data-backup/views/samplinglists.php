...
<?php 
  ...
  $query = $query."from tps_pendaratan, master_landing where master_landing.id_landing=tps_pendaratan.k_landing ";
						...
						<tr>
							...
							<td align="center" bgcolor="#CCCCCC"><b>Jenis II</b></td>	
												...
												<?php 
												  ...
												  {
													//for rowspan
													$query = "select count(distinct(thn_sampling)) as hasil from tps_pendaratan where k_landing = '".$record->k_landing."'" ; 
