      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
           ...
           <?php echo validation_errors(); ?>
                        ...
                        echo form_open_multipart('sampling/mainpage/form4_update/'.$namafile."/".$kode_species,$attributes); 
                              ?>
           ...
           <div class="row">
            ...
            <div class='col-md-4'>
                  ...
                  <tbody>
                    ...
                    <input type='hidden' name='kode_species' value='<?php echo $kode_species; ?>'>
  ...
  <button type='submit' name='submit' class='btn btn-info'>Tambah</button>
                 <a href="<?php echo base_url(); ?>sampling/mainpage/form4/<?php echo $namafile; ?>"><button type='button' class='btn btn-default pull-right'>Cancel</button></a>
