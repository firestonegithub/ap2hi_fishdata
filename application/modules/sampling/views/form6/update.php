      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
           ...
           <?php echo validation_errors(); ?>
                        ...
                        echo form_open_multipart('sampling/mainpage/form6_update/'.$namafile,$attributes); 
                              ?>
            ...
            <div class='col-md-4'>
                  ...
                  <tbody>
                    ...
                    <tr>
                       ...
                       <tr>
                            <th width='120px' scope='row'> deskripsi_foto  </th>    
                            <td><input type='text' class='form-control' name='deskripsi_foto' id="deskripsi_foto" value="<?php if( !empty($post['deskripsi_foto']) ){ echo $post['deskripsi_foto']; } ?>" autocomplete=off ></td>
                    </tr>
