      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
           ...
           <?php echo validation_errors(); ?>
                        ...
                        echo form_open_multipart('sampling/mainpage/form3_add/'.$namafile,$attributes); 
                              ?>
                  ...
                  <tbody>
                    ...
                    <tr>
                            ...
                            <td><select class="form-control" name="k_species" id="k_species">
                              ...
                              <?php foreach($k_species as $key=>$value){ ?>
                                        <option value="<?php echo $key ; ?>" <?php if( !empty($post['k_umpan']) ){  if ( $post['k_umpan'] == $key ) { echo 'selected'; } } ?> ><?php echo $value ; ?></option>
                                       <?php  } ?>
                                 </select>
                       ...
                       <tr>
                            ...
                            <td><input type='text' class='form-control' name='jumlah' id="jumlah" value="<?php if( !empty($post['jumlah']) ){ echo $post['jumlah']; } ?>" autocomplete=off ></td>
                    </tr>
                       ...
                       <tr>
                            ...
                            <td><input type='text' class='form-control' name='estimasi' id="estimasi" value="<?php if( !empty($post['estimasi']) ){ echo $post['estimasi']; } ?>" autocomplete=off >
                     ...
                     <tr>
                            ...
                            <td><input type='text' class='form-control' name='panjang' id="panjang" value="<?php if( !empty($post['panjang']) ){ echo $post['panjang']; } ?>" autocomplete=off >
                            </td>
                    </tr>
