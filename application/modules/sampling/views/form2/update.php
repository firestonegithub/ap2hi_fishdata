      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
           ...
           <?php echo validation_errors(); ?>
                        ...
                        echo form_open_multipart('sampling/mainpage/form2_update/'.$namafile."/".$urut,$attributes); 
                              ?>
                    ...
                    <tr>
                     ...
                     <tr>
                       ...
                       <tr>
                            ...
                            <td><input type='text' class='form-control' name='pl_jum_ember' id="pl_jum_ember" value="<?php if( !empty($post['pl_jum_ember']) ){ echo $post['pl_jum_ember']; } ?>" autocomplete=off ></td>
                    </tr>

                    
                       <tr>
                            <th width='120px' scope='row'>Estimasi Umpan (Kg) </th>    
                            <td><input type='text' class='form-control' name='estimasi' id="estimasi" value="<?php if( !empty($post['estimasi']) ){ echo $post['estimasi']; } ?>" autocomplete=off ></td>
                    </tr>

                     
                       <tr>
                            <th width='120px' scope='row'>Estimasi Umpan  (Ekor)</th>    
                            <td><input type='text' class='form-control' name='hl_estimasi_ekor_umpan' id="hl_estimasi_ekor_umpan" value="<?php if( !empty($post['hl_estimasi_ekor_umpan']) ){ echo $post['hl_estimasi_ekor_umpan']; } ?>" autocomplete=off ></td>
                    </tr>

                    
                       <tr>
                            <th width='120px' scope='row'>Alat Tangkap Umpan</th>    
                            <td><input type='text' class='form-control' name='k_alattangkap' id="k_alattangkap" value="<?php if( !empty($post['k_alattangkap']) ){ echo $post['k_alattangkap']; } ?>" autocomplete=off ></td>
                    </tr>
