  ...
  <div class="card">
    ...
    <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
      <div class="card-body">
          ...
          <div><center> <a href="<?php echo base_url()."data/mainpage/download_extract_unloading"; ?>" class="btn btn-success"  >Download</a> </center></div>
                ...
                <div class="modal-header">
                 ...
                 <div class="modal-body">
                  <?php //echo form_open_multipart($url_uploadUnloading);  ?>
					...
					<!-- 
					FOR CHECKING DATA UPLOADER RESULT
					<?php echo form_open_multipart($url_uploadUnloadingExsist);  ?>
                    <center>
                    <div class="form-group">
                      <input type="text" name="namafile" />
                      <button  class="btn btn-default">Namafile check</button>
                    </div> 
                    </center>
                     <?php echo form_close(); ?>
					-->
                                     ...
                                     for (i = 0; i < response.statusInsert.excellInsert.length; i++) {
                                      ...
                                      if(response.statusInsert.excellInsert[i].act == 'Bad'){
                                       ...
                                       if(response.statusInsert.excellInsert[i].act == 'Good'){
										...
										if(response.statusInsert.excellInsert[i].act == 'Warning'){
                                                                    ...
                                                                    //console.log(response.statusInsert.excellInsert[0]);  
                                                                      console.log(response.statusInsert.excellInsert[i].act);
																		...
																		if(response.statusInsert.excellInsert[i].act == 'Warning'){
                                                                          ...
                                                                          textInsert += '<div class="alert alert-warning alert-dismissible" role="alert">'+
                                                                            '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>'+
                                                                            '<strong> <span class="glyphicon glyphicon-ok-sign"></span> </strong>'+response.statusInsert.excellInsert[i].notif+
                                                                          '</div>';
