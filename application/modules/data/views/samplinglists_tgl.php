        ...
        <div class="card-body">
			...
			<table border="0" width="100%" style="padding:10px 10px;">
				<tr>
					...
					<td><?php echo $record->nama_landing; ?></td>
...
$query = "SELECT namafile,k_perusahaan,jam_sampling,mnt_sampling,nama_kapal, total_penangkapan as tot1, est_ikanhilang as est , tipe from tps_pendaratan where k_landing='".$mk_tpi."' and thn_sampling=".$thn." and bln_sampling=".$mbulan." and tgl_sampling=".$mtgl."  and status_trip = '1'  order by jam_sampling,mnt_sampling";
$result = $this->db->query($query)->result();
$mt1=0; $mt3=0; $mt4=0;
...
k_landing='".$mk_tpi."' and thn_sampling=".$thn." and bln_sampling=".$mbulan." and tgl_sampling=".$mtgl." and jam_sampling=".$record->jam_sampling." and mnt_sampling=".$record->mnt_sampling."  and status_trip = '1'  group by k_species";
...
//Ikan Kecil Summary Start 
	...
	$query=$query." and k_landing='".$mk_tpi."'";
